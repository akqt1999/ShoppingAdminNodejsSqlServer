...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.MyViewHolder>{
    ...
    public void onBindViewHolder(@NonNull @NotNull UserAdapter.MyViewHolder holder, int position) {
        holder.txt_name.setText(userList.get(position).getNameUser());
        holder.txt_phone_number.setText(userList.get(position).getPhoneUser());
        holder.txt_status.setText(new StringBuilder("trang thai:")
        ...
        holder.setListener(new IOnRecycleViewClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Toast.makeText(context, userList.get(position).getNameUser(), Toast.LENGTH_SHORT).show();
            }
        });
    }
